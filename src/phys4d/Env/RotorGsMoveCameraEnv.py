...
class RotorGsMoveCameraEnv(TaskCameraBaseEnv):
    """
    RotorGsMoveCamera environment for automatic data collection.
    This environment is designed for collecting data from phys4d scenes.
    Similar to BallAndBlockEnv but without background wall.
    """
    ...
    def reset(self, seed: int | None = None, options: dict[str, Any] | None = None):
        """Reset all environments and clear previous ball positions and step counts."""
    ...
    def reset_idx(
        ...
        """Reset specific environments and clear their previous ball positions and step counts."""
    ...
    def get_done(
        ...
        done_mask = self._step_counts[env_ids] >= 250
