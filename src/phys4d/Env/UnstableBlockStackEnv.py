...
class UnstableBlockStackEnv(TaskCameraBaseEnv):
    """
    Unstable Block Stack environment for automatic data collection.
    This environment is designed for collecting data from phys4d scenes.
    get_done env  200  step
    """
    ...
    def get_done(
        ...
        done_mask = self._step_counts[env_ids] >= 200
