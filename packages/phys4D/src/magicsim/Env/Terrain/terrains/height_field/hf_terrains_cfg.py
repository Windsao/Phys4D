...
class StairsTerrainCfg(HfTerrainBaseCfg):
    ...
    step_width_range = [0.35, 0.5]
    inverted: bool = False


@configclass
class ParkourTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a pyramid stairs height field terrain."""

    function = hf_terrains.parkour_terrain
...
@configclass
class HurdleTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a pyramid stairs height field terrain."""

    function = hf_terrains.hurdle_terrain
...
@configclass
class BridgeTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a pyramid stairs height field terrain."""

    function = hf_terrains.bridge_terrain
...
@configclass
class PlatformTerrainCfg(HfTerrainBaseCfg):
    """Configuration for a pyramid stairs height field terrain."""

    function = hf_terrains.platform_terrain
