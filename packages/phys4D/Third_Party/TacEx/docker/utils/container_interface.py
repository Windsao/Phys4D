...
class ContainerInterface:
    ...
    def __init__(
        ...
        self.container_name = "isaac-lab-tacex"
        self.image_name = "isaac-lab-tacex:latest"
    ...
    def build(self):
        """Build and start the Docker container of the Extension using the Docker compose command."""
        print(
