...
class BallRollingTactileRGBUipcCfg(DirectRLEnvCfg):
    ...
    object: UipcObjectCfg = UipcObjectCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.25, -0.35, 0.0051 + 0.0025)),
        spawn=sim_utils.UsdFileCfg(
    ...
    reward_cfg = {
        ...
        "obj_goal_tracking": {"weight": 0.75, "std": 0.6},
    ...
    goal_randomization_range_x = [0.0, 0.5]
    goal_randomization_range_y = [0.0, 0.7]
...
class BallRollingTactileRGBUipcEnv(UipcRLEnv):
    ...
    def __init__(self, cfg: BallRollingTactileRGBUipcCfg, render_mode: str | None = None, **kwargs):
        ...
        self._goal_pos_b[:, 2] = self.cfg.ball_radius * 2 + 0.0025
