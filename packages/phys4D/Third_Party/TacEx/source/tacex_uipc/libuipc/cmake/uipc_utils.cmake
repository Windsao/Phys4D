...
function(uipc_config_vcpkg_install)
    ...
    execute_process(
        ...
        ${VCPKG_MANIFEST_DIR}
        "--build_gui=${UIPC_BUILD_GUI}"
        "--dev_mode=${UIPC_DEV_MODE}"
        "--with_usd_support=${UIPC_WITH_USD_SUPPORT}"
        "--with_vdb_support=${UIPC_WITH_VDB_SUPPORT}"
        "--with_cuda_backend=${UIPC_WITH_CUDA_BACKEND}"
