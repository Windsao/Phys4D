...
With the same basic idea, we use a more general and well-defined way to represent such kind of geometry in the `libuipc` library, called [Simplicial Complex](https:
...
In the field of rendering, [instancing](https:
...
=== "C++"
    ...
    To use the `spreadsheets`, you need to include the header file `
