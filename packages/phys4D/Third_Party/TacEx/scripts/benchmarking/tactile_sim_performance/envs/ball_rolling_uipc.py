...
class UipcEnvCfg(PhysXRigidEnvCfg):
    ...
    ball = UipcObjectCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.5, 0, 0.01]),
    ...
    gsmini = GelSightMiniCfg(
        ...
        sensor_camera_cfg=GelSightMiniCfg.SensorCameraCfg(
            ...
            resolution=(320, 240),
            data_types=["depth"],
            clipping_range=(0.02, 0.034),
        ),
        device="cuda",
        debug_vis=True,

        data_types=["tactile_rgb", "marker_motion", "camera_depth"],
    )
    ...
    gsmini.marker_motion_sim_cfg = gsmini.marker_motion_sim_cfg.replace(
        ...
        frame_transformer_cfg=FrameTransformerCfg(
            ...
            source_frame_offset=OffsetCfg(rot=(0.0, 0.92388, -0.38268, 0.0)),
