...
class NonHolonomicAction(ActionTerm):
    ...
    def apply_actions(self):
        ...
        self._joint_vel_command[:, 0] = torch.cos(yaw_w) * self.processed_actions[:, 0]
        self._joint_vel_command[:, 1] = torch.sin(yaw_w) * self.processed_actions[:, 0]
        self._joint_vel_command[:, 2] = self.processed_actions[:, 1]
