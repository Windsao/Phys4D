...
def object_placed_upright(
    ...
    object_euler_x, object_euler_y, _ = math_utils.euler_xyz_from_quat(object.data.root_quat_w)

    object_euler_x_err = torch.abs(math_utils.wrap_to_pi(object_euler_x))
    object_euler_y_err = torch.abs(math_utils.wrap_to_pi(object_euler_y))
